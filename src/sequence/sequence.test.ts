...
describe('Sequence', () => {
  ...
  describe('Direct Async Map', () => {
    ...
    describe('Destruction', () => {
      ...
      describe('destroying pipeline', () => {
        ...
        // TODO: finalize a link that comes after should destroy ongoing items of this
      });
    });
  ...
  describe('Drop Ongoing Async Map', () => {
    describe('Triggers', () => {
      test('simple sequence sync triggers', () => {
        let heap: string[] = [];
    ...
    describe('Edge Cases', () => {
      test('destroying subscriptions via attachment, instantly finalizing sequence', () => {
        ...
        let sequence = Sequence.create((resolve, context) => {
          ...
          .asyncMapDropOngoing<void>((_, context) =>
            Sequence.create(resolve => {
              variable
                .subscribe(() => {
                  triggered = true;
